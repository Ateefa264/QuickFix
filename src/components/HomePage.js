...
import call_us from '../images/call_us.png';
...
const handleWorkWithUsClick = () => {
    // Navigate to the "Apply Now" page directly
    navigate('/apply-now');
  };  
    ...
    <div className="homepage">
      ...
      <header className="navbar">
        ...
        <nav>
          ...
          <button onClick={() => navigate('/login')} className="auth">Login</button>
          <button onClick={() => navigate('/InitialSignup')} className="auth">Sign up</button>
        </nav>
      </header>
      ...
      <section className="intro">
        ...
        <button className="call-us-btn" onClick={handleWorkWithUsClick}>
          <img src={call_us} alt="Call Us" />
        </button>
